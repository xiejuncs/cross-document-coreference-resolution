 ...
 *
 */
public class CrossCoreferenceResolutionStochasticGradientGold extends ExperimentConstructor {
	...
	protected void performExperiment() {
		...
		calcualateWeightDifference(weights);
	...
	private void configureExperiment() {
		...
		addParas(EecbConstants.CLASSIFIER, "learningRate", 0.5);
		...
		double learningrate = (Double) getParameter(EecbConstants.CLASSIFIER, "learningRate");
		...
		experimentResultFolder = outputPath + timeStamp + "-" + classifierLearningModel + "-" + classifierNoOfIteration + "-" + learningrate + "-" + searchModel + "-" + searchWidth + "-" + searchStep + "-" + stoppingRate;
	...
	public static void main(String[] args) {
		CrossCoreferenceResolutionStochasticGradientGold ccrs = new CrossCoreferenceResolutionStochasticGradientGold();
