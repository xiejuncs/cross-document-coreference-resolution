...
/**
 * Cross Coreference Resolution with Stochastic Gradient by Latest Weight
 * 
 ...
 * The latest weight is used to do testing, In addition, the training data is used to validate the weight, So there are one training 
 * set and two testing sets
 * 
 * @author Jun Xie (xie@eecs.oregonstate.edu)
 *
 */
public class CrossCoreferenceResolutionStochasticGradientGoldLatestWeight extends ExperimentConstructor {
	...
	public static void main(String[] args) {
		CrossCoreferenceResolutionStochasticGradientGoldLatestWeight ccrs = new CrossCoreferenceResolutionStochasticGradientGoldLatestWeight();
