 ...
 *
 */
public class StanfordExperimentwithCoNLLScoring extends StanfordExperiment {

	public StanfordExperimentwithCoNLLScoring(String configurationPath) {
	...
	public static void main(String[] args) {
		...
		//String configurationPath = "/scratch/JavaFile/stanford-corenlp-2012-05-22/src/edu/oregonstate/experimentconfigs/cluster-flat-stanford-predicted.properties";
		String configurationPath = args[0];
		StanfordExperimentwithCoNLLScoring sge = new StanfordExperimentwithCoNLLScoring(configurationPath);
