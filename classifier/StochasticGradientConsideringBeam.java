 ...
 *
 */
public class StochasticGradientConsideringBeam implements IClassifier {
	...
	/** calculate the weight according to whether the score of one state is better than that of the other state */
	private double[] calculatePairwiseWeight() {
		...
		for (int i = 0; i < beamLists.size(); i++) {
			State<CorefCluster> iState = beamLists.get(i);
